...
import '../../more-styles/some-styles.css';
...
import '~/styles/somewhere/some-sassy-styles.scss';
import * as Abathur from '~/Abathur';
import {action, computed} from 'mobx';
import '~/styles/some-stylish-styles.styl';
...
import '_/styles/somewhere/some-sassy-styles.scss';
...
import {ccc, aaa, bbb} from 'bbb';
import * as React from 'react';
import '_/styles/some-stylish-styles.styl';
